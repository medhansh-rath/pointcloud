...
int main(int argc, char** argv) {
    ...
    std::cout << "cv::imread time: " << std::chrono::duration<double, std::milli>(t_imread_end - t_load_start).count() << " ms" << std::endl;
    auto t_load_end = std::chrono::high_resolution_clock::now();
    std::cout << "Image loading time: " << std::chrono::duration<double, std::milli>(t_load_end - t_load_start).count() << " ms" << std::endl;
    ...
    std::cout << "Image preprocessing time: " << std::chrono::duration<double, std::milli>(t_preproc_end - t_preproc_start).count() << " ms" << std::endl;
    ...
    std::cout << "GPU allocation time: " << std::chrono::duration<double, std::milli>(t_alloc_end - t_alloc_start).count() << " ms" << std::endl;
    ...
    std::cout << "Image upload time: " << std::chrono::duration<double, std::milli>(t_upload_end - t_upload_start).count() << " ms" << std::endl;
    ...
    if (save_filled_depth_nearest) {
        ...
        std::cout << "Nearest method time: " << elapsed << " ms" << std::endl;
    }
    if (save_filled_depth_avg) {
        ...
        std::cout << "Average method time: " << elapsed << " ms" << std::endl;
    }
    if (save_filled_depth_blob) {
        ...
        std::cout << "Blob method time: " << elapsed << " ms" << std::endl;
    }
    if (save_filled_depth_jfa) {
        ...
        std::cout << "Jump Flooding method time: " << elapsed << " ms" << std::endl;
    }
    auto t_hole_end = std::chrono::high_resolution_clock::now();
    auto t_filesave_end = std::chrono::high_resolution_clock::now();
    std::cout << "Hole filling time (GPU + download): " << std::chrono::duration<double, std::milli>(t_hole_end - t_hole_start).count() << " ms" << std::endl;
    std::cout << "File I/O save time: " << std::chrono::duration<double, std::milli>(t_filesave_end - t_filesave_start).count() << " ms" << std::endl;
    ...
    std::cout << "Point cloud computation time: " << std::chrono::duration<double, std::milli>(t_cloud_end - t_cloud_start).count() << " ms" << std::endl;
    ...
    std::cout << "Normals/reproject time: " << std::chrono::duration<double, std::milli>(t_normals_end - t_normals_start).count() << " ms" << std::endl;
    ...
    std::cout << "Download time: " << std::chrono::duration<double, std::milli>(t_download_end - t_download_start).count() << " ms" << std::endl;
    ...
    std::cout << "PCL conversion & PCD save time: " << std::chrono::duration<double, std::milli>(t_pcl_end - t_pcl_start).count() << " ms" << std::endl;
    ...
    std::cout << "Cleanup time: " << std::chrono::duration<double, std::milli>(t_cleanup_end - t_cleanup_start).count() << " ms" << std::endl;
